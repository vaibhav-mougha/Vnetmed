      ...
      <Box height={"auto"} bg={"#F3F7FB"}>
        ...
        <PaymentNav>
          ...
          <Box mr={8} mt={2} color={"white"} display={"flex"} gap={8}>
            <Box>
              {/* <Image height={30} src='https://uxwing.com/wp-content/themes/uxwing/download/19-e-commerce-currency-shopping/shopping-bag.png' alt=''/> */}
              <Link to="/cart">
                {" "}
            ...
            <Box>
              {/* <Image src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSsEZyuo17vTtXt6AiuwE5uoGTpC5j6xa8PAzLGT1luSKSv2--qTKa4K-9ZK6gyoizPKqM&usqp=CAU'/> */}
