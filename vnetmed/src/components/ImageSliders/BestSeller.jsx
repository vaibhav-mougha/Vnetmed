...
import { fetchBestSeller, fetchCovidEssentials } from "../../Redux/actions";
...
export default function BestSeller() {
  const bestSellerData = useSelector((state) => state.isAuth.bestSeller);
