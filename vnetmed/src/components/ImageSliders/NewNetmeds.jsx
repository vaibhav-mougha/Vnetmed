...
import { fetchNewOnNetmeds } from "../../Redux/actions";
...
export default function NewNetmeds() {
  const newNetmeds = useSelector((state) => state.isAuth.newOnNetmeds);
  console.log(newNetmeds);
